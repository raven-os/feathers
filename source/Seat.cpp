...
void Seat::seat_request_set_selection([[maybe_unused]]struct wl_listener *listener, void *data)
{
...
void Seat::seat_request_set_primary_selection([[maybe_unused]]struct wl_listener *listener, void *data)
{
