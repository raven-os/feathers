...
void Seat::seat_request_set_selection(struct wl_listener *listener, void *data)
{
...
void Seat::seat_request_set_primary_selection(struct wl_listener *listener, void *data)
{
